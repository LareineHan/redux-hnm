...
import { productAction } from '../redux/actions/productAction'; // 이 액션을 콜하기 위해 디스패치 필요
...
const Products = () => {
	...
	const getProducts = async () => {
		...
		dispatch(productAction.getProducts(searchQuery)); // 액션을 디스패치한다.그러면 getProducts가 실행되고, 그 결과를 productList에 저장한다.
	};
